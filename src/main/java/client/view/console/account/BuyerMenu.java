...
import client.model.product.SelectedProduct;
import client.model.receipt.BuyerReceipt;
import client.view.console.Menu;
import client.view.console.product.ProductMenu;
...
public class BuyerMenu extends Menu {
    ...
    private void setRegex() {
        ...
        regex.add("edit (\\w+)");
        regex.add("client.view cart");
        regex.add("show products");
        regex.add("client.view product (\\w+)");
        regex.add("increase (\\d+) (\\d+)");
        regex.add("decrease (\\d+) (\\d+)");
        regex.add("show total price");
        regex.add("purchase");
        regex.add("client.view orders");
        regex.add("show order (\\w+)");
        regex.add("rate (\\d+) (\\d+)");
        regex.add("client.view discount codes");
        regex.add("logout");
