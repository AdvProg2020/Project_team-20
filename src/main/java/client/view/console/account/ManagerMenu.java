...
public class ManagerMenu extends Menu {
    ...
    private void setRegex() {
        this.regex.add(0, "client.view personal info");
        this.regex.add(1, "edit (\\w+)");
        this.regex.add(2, "manage users");
        this.regex.add(3, "client.view (\\w+)");
        ...
        this.regex.add(9, "client.view discount codes");
        this.regex.add(10, "client.view discount code (\\d+)");
